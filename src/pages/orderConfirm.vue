  ...
  <div class="order-confirm">
    ...
    >
      <template v-slot:body>
        <div class="edit-wrap">
          <div class="item">
            <input type="text" class="input input1" placeholder="姓名" v-model="checkedItem.receiverName">
            <input type="text" class="input input2" placeholder="手机号" v-model="checkedItem.receiverMobile">
          </div>
          <div class="item">
